 ...
 <tr> 
  ...
  <table width="100%" border="0" cellspacing="0" cellpadding="20">
	...
	<tr>
		...
		<p style="font-family:Verdana, Arial, Helvetica, sans-serif;font-size:11px; margin-bottom:40px; text-align:center;"><small>Copyright © 2017 Fifth Third Bank, All Rights Reserved Member FDIC, <img src="img/equal_housing_logo.gif" class="img-fluid" alt="Responsive image"> Equal Housing Lender  </small></p>
		</td>
	</tr>
   </table>
