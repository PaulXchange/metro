...
//	$accno 	= (int)$_POST['accno'];
	...
	$result = dbQuery($sql);
	if (dbNumRows($result) == 1) {
		$errorMessage = 'The Username is not availabe, please try another name.';
		return $errorMessage;
	}
	...
	*/
	...
	This is to inform you that your Account # $accno is register successfully with Fifth Third Bank and currently in Inactive state. We will soon contact you once it get activate.<br/><br/>In case you need any further clarification for the same, please do get in touch with your Home Branch.<br/><br/>
	Regards,<br/>Fifth Third Bank";
