...
$result = mysqli_query($dbConn, $sql) or die('Cannot get product. ' . mysqli_error($dbConn));
$row = mysqli_fetch_assoc($result);
extract($row);
$atype = "";
if ($type == "CA") {$atype = "Checking Account";} else if ($type == "SA") {$atype = "Saving Account";} else if ($type == "FDA") {$atype = "Fixed deposit Account";}
?>
